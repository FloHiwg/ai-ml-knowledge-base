...
#### But is it really that bad? [#](https://simonwillison.net/2023/Apr/14/worst-that-can-happen/#really-that-bad)
...
#### The rogue assistant [#](https://simonwillison.net/2023/Apr/14/worst-that-can-happen/#rogue-assistant)

Here’s a great example of a system that is likely to have serious problems with prompt injection:

On the one hand, this is _really cool_. Justin Alvey has built an assistant prototype that runs on his phone, uses Whisper to listen to voice instructions, then runs them through ChatGPT API prompts to perform actions like searching his email for answers to questions and even send replies based on his dictated instructions.
...
> 
> Assistant: get\_emails --recency 2 days --unread -- important
> 
...
#### Search index poisoning [#](https://simonwillison.net/2023/Apr/14/worst-that-can-happen/#search-index-poisoning)
...
#### Data exfiltration attacks [#](https://simonwillison.net/2023/Apr/14/worst-that-can-happen/#data-exfiltration)
...
#### Indirect Prompt Injection [#](https://simonwillison.net/2023/Apr/14/worst-that-can-happen/#indirect-prompt-injection)
...
#### A partial solution: show us the prompts! [#](https://simonwillison.net/2023/Apr/14/worst-that-can-happen/#show-us-the-prompts)
...
That 5% is the problem though: in security terms, if you only have a tiny window for attacks that work an adversarial attacker _will_ find them. And probably share them on Reddit.
...
#### Ask for confirmation [#](https://simonwillison.net/2023/Apr/14/worst-that-can-happen/#ask-for-confirmation)
...
#### Help developers understand the problem [#](https://simonwillison.net/2023/Apr/14/worst-that-can-happen/#help-developers-understand)
...
#### GPT-4 is better, but it’s still not a solved problem [#](https://simonwillison.net/2023/Apr/14/worst-that-can-happen/#gpt4)
